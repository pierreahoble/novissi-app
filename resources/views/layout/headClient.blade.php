                    ...
                    <div class="col-md-12">
                        <div class="top-bar-wrap">
                            <div class="top-bar-left">
                                <div class="top-bar-text"><a href="#" class="font-medium display-inline">Nous Collectons:</a> Vous voulez faire une collecte d'aide a votre communauté ?</div>
                            </div>
                                ...
                                <ul class="top-bar-info">
                                    <li class="info-item">
                                        <a href="tel:01228899900" class="info-link">
                                            ...
                                            <span class="info-text"><strong>00228 8899900</strong></span>
                                        </a>
                                    </li>
                                    <li class="info-item">
                                        <i class="info-icon fa fa-map-marker-alt"></i>
                                        <span class="info-text">Lome - Adidogome # Amadahome</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="header__navigation menu-style-three d-none d-xl-block">
                                    <nav class="navigation-menu">
                                        <ul>
                                            ...
                                            <li class="has-children--multilevel-submenu">
                                                <a href="{{url('login')}}" class="ht-btn ht-btn-sm"><span>Connexion</span></a>
                                                <!-- multilevel submenu -->
                                                {{-- <ul class="submenu">
