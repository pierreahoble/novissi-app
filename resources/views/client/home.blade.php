...
@section('contenu')
                        ...
                        <div class="col-lg-12 col-md-12 ml-auto mr-auto">
                            <div class="service-hero-wrap wow move-up">
                                <div class="service-hero-text text-center">
                                    <h3 class="text-white">Novissi   </h3>
                                    <h1 class="font-weight--reguler text-white mb-30">AMELEMIASSI</h1>
                                    <p class="text-white">-- Faites nous confiance.--</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="feature-images-wrapper bg-gray mt-5">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- section-title-wrap Start -->
                            <div class="section-title-wrap text-center">
                                <h6 class="section-sub-title">Nos Partenaires</h6>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- section-title-wrap Start -->
                            <div class="section-title-wrap text-center">
                                <h6 class="section-sub-title">Collectes</h6>
                                {{-- <h3 class="heading">For your very specific industry, <br> we have <span class="text-color-primary"> highly-tailored IT solutions.</span></h3> --}}
                            </div>
                            <!-- section-title-wrap Start -->
                        </div>
